...
export default function Home() {
    return (
        <main className="inline-flex min-h-screen flex-col p-24 text-3xl gap-4 max-sm:text-xl max-sm:p-10">
                <div style={{ width: "200px", height: "200px", borderRadius: "50%", overflow: "hidden" }} className="absolute right-24 max-md:relative max-md:m-auto max-md:w-1/2 max-md:right-0">
                    <Image
